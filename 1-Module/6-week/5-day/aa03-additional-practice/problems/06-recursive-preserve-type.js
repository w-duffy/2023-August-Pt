...
let recursivePreserveType = (array) => {
...
//one liner for fun -- not a recommended way to write code
// let recursivePreserveType = array => (type, newArr = [], index = 0) => index === array.length ? newArr : (type === (typeof array[index]) && newArr.push(array[index]), recursivePreserveType(array)(type, newArr, index + 1));
