...
//Jacob's approach we used inside of if blocks.
//used this instead of the original "totalCost += 1".
const butter = 1;
const eggs = 2;
const milk = 3;
const bread = 4;
...
/*
Emily's Solution using indexOf:
...
/*
Michael's Solution using an object:
let prices = {
    'butter': 1,
    'eggs': 2,
    'milk': 3,
...
function mostExpensiveGroceries(groceriesList) {
  ...
  for (let i = 0; i < groceriesList.length; i++) {
    ...
    /*
    John's approach that doesn't require us to track highestCost explicitly:
