...
function, 'dynamicDice(sides)'. The 'dynamicDice' function should return a
'NEW FUNCTION', that accepts a number representing the total rolls you get
multiplied by the sides of the dice from the first function. The returned
function should return the maximum number you can get based on the sides of the
dice, and the amount of rolls you are allotted.

For example if you have a 20 sided die, and can only roll it once, the highest
number you can get is 20.
